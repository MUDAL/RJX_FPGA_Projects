...
if {[is_project_open]} {
	if {[string compare $quartus(project) "rdc"]} {
		puts "Project rdc is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists rdc]} {
		project_open -revision rdc rdc
	} else {
		project_new -revision rdc rdc
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "07:30:12  MAY 24, 2026"
