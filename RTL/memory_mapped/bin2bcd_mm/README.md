...
| Output Data | 0x0C | R | Holds the output BCD data from the binary-to-bcd conversion process. This register is set/cleared by hardware. All bits in this register are read-only to software.  
